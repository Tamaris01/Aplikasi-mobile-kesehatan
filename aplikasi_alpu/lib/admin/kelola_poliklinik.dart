                ...
                : _filteredData.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        gridDelegate:
                          ...
                          crossAxisCount: 2,
                          childAspectRatio: 1.0, // Makes the cards more square
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: const TextStyle(
                                        ...
                                        color: Color.fromARGB(255, 5, 67, 93),
                                      ),
                                    ),
                                    const SizedBox(height: 4.0),
                                    _filteredData[index]['foto_logo'] != null
                                        ? Image.network(
          ...
          builder: (BuildContext context, BoxConstraints constraints) {
            return FlexibleSpaceBar(
              title: SingleChildScrollView(
                ...
                child: Text(
                  "${widget.poliData['nama_poliklinik'][0].toUpperCase()}${widget.poliData['nama_poliklinik'].substring(1).toLowerCase()}",
                  style: const TextStyle(
                    color: Colors.white,
                  ),
                ),
